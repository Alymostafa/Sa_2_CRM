...
session_start();
if(@$_SESSION['role']!=1){
	echo"OOOPSIEE .... YOU ARE NOT AN ADMIN YOU SNEAKY BITCH";
die();}
$user=new Admin();

if(isset($_POST['submit'])){
	//  $customer = new Customer();
	//  $user->get_report($customer);
	$user_id=$_POST['id'];
	...
	<div class="left main-sidebar">
		...
		<div class="sidebar-inner leftscroll">
			...
			<ul>
					...
					<li class="submenu">
						<a class="active" href="adminhome.php"><i class="fa fa-fw fa-bars"></i><span> Dashboard </span> </a>
                    </li>
					...
					<li class="submenu">
                        <a href="#"><i class="fa fa-fw fa-table"></i> <span>Manage Users</span> <span class="menu-arrow"></span></a>
							<ul class="list-unstyled">
								<li><a href="../view/viewcustomer.php">View Customers</a></li>
								<li><a href="../view/viewemployee.php">View Employee</a></li>
								<li><a href="../view/viewCustomer/index.php">Edit Customers</a></li>
								<li><a href="../view/viewEmployee/index.php">Edit Employees</a></li>
							</ul>
                    </li>
										
                    <li class="submenu">
                        <a href="#"><i class="fa fa-fw fa-tv"></i> <span>Add New Users</span> <span class="menu-arrow"></span></a>
                            <ul class="list-unstyled">
                                <li><a href="../view/Register.php">Add Employee</a></li>
								<li><a href="../view/Register_c.php">Add customer</a></li>
						...
						<div class="row">
									<div class="col-xl-12">
											<div class="breadcrumb-holder">
													...
													<form method="POST">
														<label class="label--desc">Customer's ID</label>
														<input type="text" name="id" required >
														<button type="submit" value="submit" name="submit" >View report </button>
													</form>
													<div class="clearfix"></div>
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">						
							<div class="card mb-3">
								<div class="card-header">
									<h3><i class="fa fa-table"></i> Customers' Complaints</h3>
