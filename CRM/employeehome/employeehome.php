...
session_start();
if(@$_SESSION['role']!=3){
	echo"If you gonna work for free, we don't mind";
die();}
	if(isset($_POST['submit'])){
		$complaint_id=$_POST['id'];
		$complaint_state=$_POST['state'];
		$complaint_solution=$_POST['solution'];
		$user->Solution($complaint_id,$complaint_solution);
		$user->Solvecomplaint($complaint_id,$complaint_state);
	...
	<div class="left main-sidebar">
		...
		<div class="sidebar-inner leftscroll">
			...
			<ul>
                    ...
                    <!-- <li class="submenu">
                        <a href="#"><i class="fa fa-fw fa-tv"></i> <span> Manage Users </span> <span class="menu-arrow"></span></a>
                            <ul class="list-unstyled">
                                <li><a href="../view/Register.php">Add Employee</a></li>
                                <li><a href="ui-buttons.html">Add customer</a></li>
    ...
    <div class="content-page">
        ...
        <div class="content">
			...
			<div class="container-fluid">
						...
						<!-- end row --><div class="row" style="width:200%">
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">						
							<div class="card mb-3">
								...
								<div class="card-body">
									...
									<br>
									 <form method="POST" >
                                                    <label class="label--desc">Complaint ID</label>
													<input type="number" name="id" required > <br> <br>
                                                    <label > Solution</label>
													<textarea rows="8" class="form-control editor"  type="text" name="solution" required></textarea> <br>
													<input type="radio" name="state" value="1"> Solved
  													<input type="radio" name="state" value="0"> Not Solved
