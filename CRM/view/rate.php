...
if(isset($_POST['submit'])){
    ...
    $complaint_rate=$_POST['rate'];
    $user->Rate_solution($complaint_rate,$complaint_id);
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">						
							<div class="card mb-3">
								<div class="card-header">
									<h3><i class="fa fa-table"></i> Your Complaints</h3>
								...
								<div class="card-body">
									...
									<table  id="example1" class="table table-bordered table-hover display">
										...
										<?php
                                                                                        ...
                                                                                        $query= mysqli_query($conn,"SELECT * from `solution` where customer_id ='$curent_user_id' ");
                                                                                        $query1=mysqli_query($conn,"SELECT * from `complaint` where `customer_id`='$curent_user_id' and `complaint_state`=1 ");
                                                                                        $count=1;
                                                                                        ...
                                                                                        while ($result= mysqli_fetch_array($query)){
                                                                                            ...
                                                                                            if(!$result['Rate']){
                                                                                           		...
                                                                                           		echo "<tr> 
                                                                                            	<td>$count</td>
                                                                                            	<td>".$result1['Complaint_header']."</td>
                                    ...
                                    <form method="POST">
														...
														<button type="submit" value="submit" name="submit" >Rate </button>
													</form>
									</div>
