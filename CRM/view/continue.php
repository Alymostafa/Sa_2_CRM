...
if(isset($_POST['submit'])){
   ...
   $speedlimits=$_POST['speedlimits'];
   $cost=$_POST['cost'];
   $duration=$_POST['duration'];
   $ispname=$_POST['ispname'];
   $countryname=$_POST['countryname'];
//if($role=="employee"){
$package->setPlan_name($planname);
$package->setSpeed_limits($speedlimits);
$package->setCost($cost);
$package->setDuration($duration);
$s = $_SESSION['id'];
$customer->AddPlan($s, $package);
$isp->setName($ispname);
$isp->setID("1000");
$customer->AddIsp($isp,$s);
$country->setC_Name($countryname);
$customer->AddCountry($country,$s);
            ...
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form method="POST">
                                ...
                                <div class="row row-space">
                                    <div class="col-2">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="text" name="planname" required>
                        ...
                        <div class="form-row">
                            <div class="name">SPEED LIMITS</div>
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="speedlimits" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="cost" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row m-b-55">
                            ...
                            <div class="value">
                                <div class="row row-refine">
                                    ...
                                    <div class="col-9">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="text" name="Duration" required>
                                            <label class="label--desc"></label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="ispname" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="countryname" required>
                                </div>
                            </div>
                        </div>
