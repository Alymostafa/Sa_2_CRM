	...
	<div class="left main-sidebar">
		...
		<div class="sidebar-inner leftscroll">
			...
			<ul>
					...
					<li class="submenu">
						<a href="../adminhome/adminhome.php"><i class="fa fa-fw fa-bars"></i><span> Dashboard </span> </a>
                    </li>
					...
					<li class="submenu">
                       <a href="#"><i class="fa fa-fw fa-table"></i> <span> View </span> <span class="menu-arrow"></span></a>
						...
						<div class="col-xl-12">
								<div class="breadcrumb-holder">
										...
										<ol class="breadcrumb float-right">
											...
											<li class="breadcrumb-item active">Customers' Data Tables</li>
										</ol>
										<div class="clearfix"></div>
								</div>
						</div>
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">						
							<div class="card mb-3">
								<div class="card-header">
									<h3><i class="fa fa-table"></i> All the customers in the System</h3>
								...
								<div class="card-body">
									...
									<table  id="example1" class="table table-bordered table-hover display">
										...
										<?php
                                                                                        ...
                                                                                        $query= mysqli_query($conn,"SELECT * from `users` where user_type_id=2");
                                                                                        $count=1;
