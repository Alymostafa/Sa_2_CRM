...
$mechanic->Send_feedback($id,$feedback);
...
<div id="main">
	...
	<div class="headerbar">
        ...
        <div class="headerbar-left">
            <a href="index.html" class="logo"><img alt="Logo" src="mechanichome/assets/images/logo.png" /> <span>Admin</span></a>
        </div>
	...
	<div class="left main-sidebar">
		...
		<div class="sidebar-inner leftscroll">
			...
			<ul>
					...
					<li class="submenu">
                        <a href="#" class="active"><i class="fa fa-fw fa-table"></i> <span> Mechanic Premmesion </span> <span class="menu-arrow"></span></a>
							<ul class="list-unstyled">
                                                            <li class="active"><a href="mechanichome/tables-basic.html">Send Feedback</a></li>
                                                            <li><a href="mechanichome/tables-datatable.html">View Request</a></li>
							</ul>
                    </li>
