	...
	<div class="left main-sidebar">
		...
		<div class="sidebar-inner leftscroll">
			...
			<ul>
					...
					<li class="submenu">
						<a  href="customerhome.php"><i class="fa fa-fw fa-bars"></i><span> Dashboard </span> </a>
                    </li>
								...
								<div class="card-body">
									...
									<table  id="example1" class="table table-bordered table-hover display">
										...
										<?php
																						...
																						$query1= mysqli_query($conn,"SELECT * from `solution` where customer_id ='$curent_user_id' ");
                                                                                        $query= mysqli_query($conn,"SELECT * from `complaint` where customer_id ='$curent_user_id' ");
                                                                                        $count=1;
